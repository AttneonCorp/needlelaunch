...
// modded main.c file from nx-hbloader
...
void loadNro()
{
    ...
    extern NORETURN void targetNRO(u64 entries_ptr, u64 handle, u64 entrypoint);
    targetNRO((u64) entries, -1, entrypoint);
}
